...
interface PluginInterception {
     ...
     * @param intercept 拦截
     */
    PLUGIN_CATCH_TAP?(service: PluginService, event: WechatMiniprogram.TouchEvent<{}, {
        wdx: number;
        ddx: number;
...
export declare class PluginService<T extends PluginConstructor[] = PluginConstructor[]> {
     ...
     * @param action 默认行为
     */
    interceptEvent<K extends PluginInterceptNames>(name: K, detail: PluginInterceptDetail<K>, action?: (...args: any[]) => any): void;
    /**
     * 获取插件
     * @param key 插件 key
     */
