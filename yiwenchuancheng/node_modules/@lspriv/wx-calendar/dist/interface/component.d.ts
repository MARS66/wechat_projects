...
import type { PluginConstructor, PluginEntireMarks, PluginKeys, PluginService, PluginEventNames, ServicePluginMap } from 'src/basic/service';
...
export type CalendarInstance<T extends DataSet = {}> = WechatMiniprogram.Component.Instance<CalendarData, CalendarProp, CalendarMethod, CalendarCustomProp> & {
    dataset: T;
};
